...
structures = list()
structures.append(generate_generic_dataclass("FileToken", {"hash_val": str, "auth_token": str, "valid_until": int}))  # single use Access/permission tokens
structures.append(generate_generic_dataclass("FileIndex", {"file_name": str, "hash_val": str, "size": int, "last_access": int}))  # Holds info on file location and info
structures.append(generate_generic_dataclass("Client", {"ip": str, "port": int}))
structures.append(generate_generic_dataclass("LogEntry", {"source": str, "message": str}))
